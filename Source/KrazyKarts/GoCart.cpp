...
AGoCart::AGoCart()
{
	...
	MovementComponent = CreateDefaultSubobject<UGoCartMovementComponent>(TEXT("MovementComponent"));
	MovementReplicator = CreateDefaultSubobject<UGoCartMovementReplicator>(TEXT("MovementReplicator"));
}
